...
function add_my_menus() {
    register_nav_menus(
    array(
        'header-menu' => __( 'Header Menu', 'montreal-real-estate-alessia-kowalyk' ),
        'footer-menu' => __( 'Footer Menu', 'montreal-real-estate-alessia-kowalyk' ),
        'social-menu' => __( 'Social Menu', 'montreal-real-estate-alessia-kowalyk'),
